...
k1 = 1
k2 = 1
# out_folder_name = "advection_Gaussian_drift_T1_beta10e-3"
# out_folder_name_path = Path(out_folder_name)

# # Check if the folder exists
# if not out_folder_name_path.exists():
#     # Create the folder
#     out_folder_name_path.mkdir(parents=True)
...
# uk.tofile(out_folder_name + '/gaussian_T1_u.csv', sep = ',')
# ck.tofile(out_folder_name + '/gaussian_T1_c.csv', sep = ',')
# pk.tofile(out_folder_name + '/gaussian_T1_p.csv', sep = ',')
...
for i in range(num_steps):
    ...
    if show_plots is True and i%10 == 0:
        ...
        plt.show()
        # plt.savefig(out_folder_name + f'plot_{i:03}.png')
        # plt.close()
